...
import org.example.webshop2.review.ReviewRepository;
...
public class Seeder {
    ...
    public Seeder(AddressRepository addressRepository, UserRepository userRepository, OrderRepository orderRepository, ReviewRepository reviewRepository, ProductRepository productRepository, OrderedProductRepository orderedProductRepository, ImageRepository imageRepository) {
    ...
    public void seed(ContextRefreshedEvent event) {
        ...
        Address address = new Address("adres1","adres1","adres1","adres1","adres1", customUser1);
